...
; New to Crystal
	...
	const EVENT_PLAYERS_HOUSE_MOM_INTRO
	const EVENT_PLAYERS_HOUSE_MOM_BLOCK
	const EVENT_PLAYERS_HOUSE_MOM_GREETED
	const EVENT_PLAYERS_HOUSE_MOM_NEIGHBOR_HINT
	const EVENT_PLAYERS_NEIGHBORS_HOUSE_MEET_RIVAL
	const EVENT_LITTLEROOT_MOM_WELCOMES_YOU
	const EVENT_GOT_A_POKEMON_FROM_BIRTH
	const EVENT_GOT_TREECKO_FROM_BIRTH
	const EVENT_GOT_TORCHIC_FROM_BIRTH
	const EVENT_GOT_MUDKIP_FROM_BIRTH
	const EVENT_ROUTE101_INITIAL_RUN
	const EVENT_ROUTE101_POOCHYENA_FLEED
	const EVENT_BIRTH_LAB_THE_PROFESSOR_IS_IN
	const EVENT_ROUTE101_BEAT_POOCHYENA
	const EVENT_BIRTHLAB_FIRST_TIME_TALKING_TO_THE_PROF
	const EVENT_BIRTHLAB_LOOK_FOR_YOUR_RIVAL
	const EVENT_ROUTE103_FOUGHT_RIVAL
	const EVENT_BIRTH_LAB_GOT_POKEDEX
	const EVENT_BIRTH_LAB_THE_RIVAL_IS_IN
	const EVENT_OLDALE_TALKED_TO_THE_TRUCK_DRIVER
	const EVENT_OLDALE_GOT_POTION
	
; Unused: next 48 events

	const_next 2048
DEF NUM_EVENTS EQU const_value ; 70
