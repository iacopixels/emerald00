...
UndergroundPath_MapEvents:
	...
	def_warp_events
	warp_event  3, 22, ROUTE_5_UNDERGROUND_PATH_ENTRANCE, 3
	warp_event  3, 24, ROUTE_6_UNDERGROUND_PATH_ENTRANCE, 3

	def_coord_events

	def_bg_events
	bg_event  1, 22, BGEVENT_ITEM, UndergroundPathHiddenFullRestore
	bg_event  1, 24, BGEVENT_ITEM, UndergroundPathHiddenXSpecial
