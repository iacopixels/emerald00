...
; Route30, Route31, CherrygroveCity
	db SPRITE_RIVAL        ; 1
	db SPRITE_MOM          ; 2
	db SPRITE_FISHER       ; 3  -- wally walking
	db SPRITE_POOCHYENA    ; 4
	db SPRITE_YOUNGSTER    ; 5
	db SPRITE_OAK          ; 6  -- variable with Norman?
	db SPRITE_GRAMPS       ; 7
	db SPRITE_BUG_CATCHER  ; 8
	db SPRITE_COOLTRAINER_F; 9  -- LASS
	; max 9 of 9 walking sprites
	db SPRITE_POKE_BALL    ; 10
	db SPRITE_FRUIT_TREE   ; 11
	db SPRITE_BIRTH_BAG    ; 12 -- variable with SPRITE_TRUCK_TOOLS?
	db SPRITE_FISHER       ; 13
	db SPRITE_GRANNY       ; 14
	db SPRITE_ZIGZAGOON    ; 15 -- remove
	db SPRITE_TAILLOW      ; 16
	db SPRITE_HOOTHOOT     ; 17
	db SPRITE_TRUCK_FRONT_TOP;    18
	db SPRITE_TRUCK_FRONT_BOTTOM; 19
	db SPRITE_TRUCK_BROKE  ; 20
	db SPRITE_TRUCK_TOOLS  ; 21
	db SPRITE_TRUCK_BACK   ; 22
	db 0 ; end
	; need: EEVEE, RIVAL_STARTER (variable)
