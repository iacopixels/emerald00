...
CooltrainerMGroup:
	...
	db 26, TORCHIC, EMBER, SMOKESCREEN, RAGE, SCARY_FACE
	db 26, MUDKIP,   WITHDRAW, WATER_GUN, BITE, CURSE
	db 26, TREECKO,  LEECH_SEED, POISONPOWDER, SLEEP_POWDER, RAZOR_LEAF
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 32, TREECKO,  GROWL, LEECH_SEED, POISONPOWDER, RAZOR_LEAF
