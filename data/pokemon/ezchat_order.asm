...
.o:        db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, ZIGZAGOON, STANTLER, SPEAROW, FEAROW, OMASTAR, OMANYTE, -1
...
.ki_gi:    db SUNFLORA, WURMPLE, GYARADOS, RAPIDASH, NINETALES, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER, -1
.ku_gu:    db GLOOM, PINECO, GLIGAR, KRABBY, GRANBULL, CROBAT, -1
.ke_ge:    db ABRA, GENGAR, TAUROS, -1
.ko_go:    db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, POOCHYENA, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT, -1
...
.hi_bi_pi: db CLEFFA, AZURILL, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, PICHU, CLEFAIRY, TORCHIC, STARYU, CYNDAQUIL, SUNKERN, TEDDIURSA, VOLTORB, -1
.fu_bu_pu: db MOLTRES, FLAREON, ALAKAZAM, MAGMAR, FORRETRESS, WIGGLYTUFF, IVYSAUR, TREECKO, VENUSAUR, AERODACTYL, MAGBY, IGGLYBUFF, UMBREON, ARTICUNO, JIGGLYPUFF, SNUBBULL, -1
.he_be_pe: db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG, -1
.ho_bo_po: db HO_OH, HOOTHOOT, TAILLOW, PONYTA, SKIPLOOM, PORYGON, PORYGON2, -1
