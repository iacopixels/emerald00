...
SilverSpriteGFX::              INCBIN "gfx/sprites/rival.2bpp"
...
TruckBrokeSpriteGFX::          INCBIN "gfx/sprites/truck_broke.2bpp"
TruckToolsSpriteGFX::          INCBIN "gfx/sprites/truck_tools.2bpp"
